...
class ImageDataLoader(object):
    ...
    def get_dataset(self, dataset_type):
        ...
        """
        greyscale_images = np.zeros([NUM_TRAIN_IMAGES, IMAGE_SIZE, IMAGE_SIZE, 1])
        color_images = np.zeros([NUM_TRAIN_IMAGES, IMAGE_SIZE, IMAGE_SIZE, 2])
        class_labels = np.zeros([NUM_TRAIN_IMAGES, NUM_CLASSES])
